  ...
  return (
    <div className="w-full min-h-dvh bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto space-y-12">
        <h1 className="text-4xl font-bold text-purple-600 mb-8">Button Component Showcase</h1>
        ...
        {/* Width Variations */}
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Width Variations</h2>
          <div className="space-y-4">
            <Button width="default">Default Width</Button>
            <Button width="full">Full Width Button</Button>
            <div className="flex gap-4">
              <Button width="square" size="small">S</Button>
              <Button width="square" size="default">M</Button>
              <Button width="square" size="large">L</Button>
            </div>
          </div>
        </section>
        ...
        {/* State Variations */}
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">State Variations</h2>
          <div className="flex flex-wrap gap-4">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Loading Animation</h2>
          <div className="space-y-6">
            <div className="space-y-2">
              <h3 className="text-lg font-medium text-gray-700">Interactive Progress Demo</h3>
              <div className="flex gap-4 items-center">
                ...
                <Button onClick={handleResetLoading} layout="secondary" disabled={isAnimating}>
                  Reset
                </Button>
            ...
            <div className="space-y-2">
              <h3 className="text-lg font-medium text-gray-700">Static Progress Examples</h3>
              <div className="flex flex-wrap gap-4">
                <Button loadingAnimation={true} loadingPercent={25} fromLoadingPercent={0}>
                  25% Complete
                </Button>
                <Button loadingAnimation={true} loadingPercent={50} fromLoadingPercent={0}>
                  50% Complete
                </Button>
                <Button loadingAnimation={true} loadingPercent={75} fromLoadingPercent={0}>
                  75% Complete
                </Button>
                <Button loadingAnimation={true} loadingPercent={100} fromLoadingPercent={0}>
                  100% Complete
                </Button>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <h3 className="text-lg font-medium text-gray-700">Loading with Error State</h3>
              <div className="flex flex-wrap gap-4">
                <Button
                  loadingAnimation={true}
                  loadingPercent={50}
        ...
        <section className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button defaultPadding={false} className="px-8">Custom Padding</Button>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Span Elements (withoutButtonTag)</h2>
          <div className="flex flex-wrap gap-4">
            <Button withoutButtonTag={true}>Span Primary</Button>
            <Button withoutButtonTag={true} layout="secondary">Span Secondary</Button>
            <Button withoutButtonTag={true} layout="text">Span Text</Button>
          </div>
        </section>

        {/* Complex Combinations */}
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Complex Combinations</h2>
          <div className="flex flex-wrap gap-4">
        ...
        {/* Icon Buttons */}
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Icon-like Buttons</h2>
          <div className="flex flex-wrap gap-4">
            <Button width="square">+</Button>
            <Button width="square" layout="secondary">-</Button>
            <Button width="square" layout="danger">×</Button>
            <Button width="square" layout="green">✓</Button>
            <Button width="square" layout="text">⋯</Button>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button aria-label="Delete item" layout="danger">Delete</Button>
            <Button aria-pressed="true" active={true}>Toggle On</Button>
