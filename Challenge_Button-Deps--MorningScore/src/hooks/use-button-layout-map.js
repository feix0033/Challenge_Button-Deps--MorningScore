    ...
    const layout = {
      ...
      secondary: {
        false: [
          ...
          {
            "text-purple-500 disabled:opacity-50 disabled:pointer-events-none":
              !textColor,
          },
      ...
      filter: {
        false: [
          "bg-white hover:bg-tabshover",
          {
            "text-purple-700 disabled:opacity-50 disabled:pointer-events-none":
              !textColor,
          },
          "border border-gray-300",
        ],
      ...
      gray: {
        false: [
          "bg-white",
          {
            "text-secondary disabled:opacity-50 disabled:pointer-events-none":
              !textColor,
          },
      ...
      stateful: {
        ...
        true: [
          "bg-white hover:bg-gray-100 active:bg-gray-200",
          {
            "text-primary-600 disabled:opacity-50 disabled:pointer-events-none":
              !textColor,
          },
          "border border-gray-300 hover:gray-600",
        ],
      ...
      "danger-secondary": {
        false: [
          ...
          {
            "text-red-500 disabled:opacity-50 disabled:pointer-events-none":
              !textColor,
          },
      ...
      borderless: {
        false: [
          "bg-transparent",
          {
            "text-secondary hover:text-purple active:text-purple-300 disabled:opacity-50 disabled:pointer-events-none":
              !textColor,
          },
          "border-none",
        ],
        true: [
          "bg-transparent",
          {
            "text-secondary hover:text-purple active:text-purple-300":
              !textColor,
          },
          "border-none",
        ],
      ...
      navigation: {
        false: [
          "bg-transparent",
          {
            "text-purple-700 hover:text-purple active:text-purple-300 disabled:opacity-50 disabled:pointer-events-none":
              !textColor,
          },
          "border-none",
        ],
        true: [
          "bg-transparent",
          {
            "text-purple-700 hover:text-purple active:text-purple-300":
              !textColor,
          },
          "border-none",
        ],
      ...
      text: {
        false: [
          "bg-transparent",
          {
            "text-purple hover:text-purple-600 active:text-purple-700 disabled:opacity-50 disabled:pointer-events-none":
              !textColor,
          },
          "border-none",
        ],
        true: [
          "bg-transparent",
          {
            "text-purple hover:text-purple-600 active:text-purple-700":
              !textColor,
          },
          "border-none",
        ],
      ...
      clean: {
        ...
        true: ["bg-transparent", { "text-purple-700": !textColor }],
      },
      muted: {
        false: [
          "bg-gray-100 hover:bg-gray-200",
          {
            "text-primary disabled:opacity-50 disabled:pointer-events-none":
              !textColor,
          },
          "border border-transparent",
        ],
      ...
      toast: {
        ...
        true: ["bg-white", { "text-purple": !textColor }, ""],
      },
      none: {
        false: [],
        true: [],
        ...
        if (Object.hasOwnProperty.call(layout, buttonType)) {
          for (const state in layout[buttonType]) {
            if (Object.hasOwnProperty.call(layout[buttonType], state)) {
              layout[buttonType][state] =
                layout[buttonType][state].map(processValue);
            }
          }
        }
      }
