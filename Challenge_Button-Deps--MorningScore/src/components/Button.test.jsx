...
describe('Button Component', () => {
  ...
  describe('Loading Animation', () => {
    ...
    it('renders loading animation with correct initial width', () => {
      const { container } = render(
        <Button loadingAnimation={true} loadingPercent={0} fromLoadingPercent={0}>
          Loading
        </Button>
      )
    ...
    it('renders loading animation with progress percentage', () => {
      const { container } = render(
        <Button loadingAnimation={true} loadingPercent={75} fromLoadingPercent={50}>
          Loading
        </Button>
      )
    ...
    it('updates loading animation when loadingPercent changes', () => {
      ...
      rerender(
        <Button loadingAnimation={true} loadingPercent={75} fromLoadingPercent={25}>
          Loading
        </Button>
      )
    ...
    it('renders without loading animation when loadingAnimation is false', () => {
      ...
      const animSpan = container.querySelector('span.absolute.top-0.left-0.w-0')
  ...
  describe('withoutButtonTag Prop', () => {
    it('renders as span when withoutButtonTag is true', () => {
      const { container } = render(<Button withoutButtonTag={true}>Span Button</Button>)
